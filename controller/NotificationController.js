...
const getNotification=async (req,res)=>{
    ...
    try {
        const notification=await Notification.find({restroId:restaurantId}).sort({ createdAt: -1 });
...
module.exports={getNotification,generateNotificationForQuery,markAllAsRead,getUnreadNotificationCount};